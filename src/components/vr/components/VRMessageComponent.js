  ...
  render() {
    ...
    return (
      <a-plane width="10" height="2.5" position="0 1 -5" color="white" rotation="0 0 0" opacity="0.2">
        <a-text  position="0 0.8 0.1" align="center" width="10" value="Order Confirmation" color="#b30e0e"></a-text>
        <a-text  position="0 0 0.1" align="center" width="8" value={message} color="#000"></a-text>
        <a-text  position="0 -0.6 0.1" align="center" width="8" value={orderId} color="#000"></a-text>
